...
List<LawItemSearch> lawList = [
  ...
  LawItemSearch("৫৩", "উৎসে কর কর্তন সনদপত্র"),
  ...
  LawItemSearch("৮৫", "ব্যর্থতা, অনিয়ম বা কর ফাঁকির ক্ষেত্রে জরিমানা আরোপ"),
  LawItemSearch("৮৬",
  ...
  LawItemSearch("৯০", "করদাতার অর্থনৈতিক কার্যক্রম নিরীক্ষা এবং অনুসন্ধান"),
  LawItemSearch("৯০ক", "বার্ষিক নিরীক্ষিত আর্থিক বিবরণী দাখিল"),
  ...
  LawItemSearch("৯৬", "দেওয়ানী কার্যবিধির অধীন মূসক কর্মকর্তার ক্ষমতা"),
  ...
  LawItemSearch("১০৮", "ফরম, নোটিশ এবং দলিলাদির সত্যায়ন"),
  ...
  LawItemSearch("১২৪", "হাইকোর্ট বিভাগে আপীল"),
...
List<BdItemSearch> bdList = [
  ...
  BdItemSearch(
      "১৮গ", "পশ্চাদপদ সংযোগ শিল্প প্রতিষ্ঠানের ক্ষেত্রে পণ্য বা সেবা সরবরাহ"),
  ...
  BdItemSearch(
      "১১৮গ", "স্থানীয় পর্যায়ে মূলধনী যন্ত্রপাতি ও যন্ত্রাংশ উৎপাদনে সুবিধা"),
  BdItemSearch("১১৮",
      'আদেশ, বিজ্ঞপ্তি, ব্যাখ্যা, পরিপত্র, স্পষ্টিকরণ ইত্যাদি জারির ক্ষমতা'),
